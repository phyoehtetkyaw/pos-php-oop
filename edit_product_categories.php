...
<div class="content-body">
    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Edit Product Categories</h5></li>
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Product Categories</a></li>
        </ol>
    </div>
            ...
            <div class="col-md-10 offset-1 col-sm-12">
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible fade show">
                        ...
                        <strong>Error!</strong> <?= $_SESSION["edit_product_categories_error"] ?>
                        ...
                        <div class="basic-form">
                            <form method="post">
                                ...
                                <div class="mt-2">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
